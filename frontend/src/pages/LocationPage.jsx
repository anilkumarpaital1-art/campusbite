...
export default function LocationPage() {
  ...
  <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top,_#facc15,_transparent_60%)] opacity-10"></div>
      ...
      <div className="w-full max-w-3xl">
        ...
        <p className="text-gray-500 mt-4 text-sm md:text-base tracking-wide">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-5">
          ...
          {locations.map((loc) => (
            <button
                ...
                className="group relative h-20 rounded-2xl bg-white border border-gray-200 shadow-sm hover:shadow-xl transition-all duration-300 flex items-center justify-center overflow-hidden hover:-translate-y-1 hover:scale-[1.03]"
                >

                {/* 🔥 TEXT */}
                <span className="text-lg font-bold text-gray-800 group-hover:text-yellow-500 transition z-10 tracking-wide">
                    {loc}
                </span>
